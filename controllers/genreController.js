            ...
            Genre.findOne({ 'name': req.body.name })
                 .exec(function(err, found_genre) {
                     ...
                     if (found_genre) {
                        ...
                        //  res.json({ message: genre, success: true });
...
exports.genre_delete_get = function(req, res) {
    ...
    // and delete the books first, before the genre.
...
exports.genre_delete_post = function(req, res) {
    ...
    // get the genre and the books with this genre
    ...
    async.parallel({
        ...
        if (results.genre_books.length > 0) {
            // Genre still has some books. so we re-render
            res.render('genre_delete', {
            ...
            // Genre has no books
            // Delete genre object
            // and redirect back to the list of genres
...
exports.genre_update_post = function(req, res) {
    ...
    console.log(`got to update genre controller...`);
    // validate field.
    ...
    (req, res, next) => {
        ...
        // Get the validation errors from a request.
        const errors = validationResult(req);
        ...
        if (!errors.isEmpty()) {
            // We got errors. Render form again with sanitized values/error messages.
            ...
            Genre.findByIdAndUpdate(req.params.id, genre, {}, function(err, the_genre) {
                console.log(`the genre ${the_genre}`);
                if (err) { return next(err); }
